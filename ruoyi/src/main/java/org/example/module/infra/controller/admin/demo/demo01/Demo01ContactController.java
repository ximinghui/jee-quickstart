package org.example.module.infra.controller.admin.demo.demo01;
...
import org.example.module.infra.controller.admin.demo.demo01.vo.Demo01ContactPageReqVO;
import org.example.module.infra.controller.admin.demo.demo01.vo.Demo01ContactRespVO;
import org.example.module.infra.controller.admin.demo.demo01.vo.Demo01ContactSaveReqVO;
import org.example.module.infra.dal.dataobject.demo.demo01.Demo01ContactDO;
import org.example.module.infra.service.demo.demo01.Demo01ContactService;
...
public class Demo01ContactController {
    ...
    public CommonResult<Long> createDemo01Contact(@Valid @RequestBody Demo01ContactSaveReqVO createReqVO) {
        return CommonResult.success(demo01ContactService.createDemo01Contact(createReqVO));
    }
    ...
    public CommonResult<Demo01ContactRespVO> getDemo01Contact(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(demo01Contact, Demo01ContactRespVO.class));
    }
    ...
    public CommonResult<PageResult<Demo01ContactRespVO>> getDemo01ContactPage(@Valid Demo01ContactPageReqVO pageReqVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, Demo01ContactRespVO.class));
    }
