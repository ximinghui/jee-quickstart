package org.example.module.infra.controller.admin.demo.demo03;
...
import org.example.module.infra.controller.admin.demo.demo03.vo.Demo03StudentRespVO;
import org.example.module.infra.controller.admin.demo.demo03.vo.Demo03StudentSaveReqVO;
import org.example.module.infra.dal.dataobject.demo.demo03.Demo03CourseDO;
...
import org.example.module.infra.service.demo.demo03.Demo03StudentService;
...
public class Demo03StudentController {
    ...
    public CommonResult<Long> createDemo03Student(@Valid @RequestBody Demo03StudentSaveReqVO createReqVO) {
        return CommonResult.success(demo03StudentService.createDemo03Student(createReqVO));
    }
    ...
    public CommonResult<Demo03StudentRespVO> getDemo03Student(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(demo03Student, Demo03StudentRespVO.class));
    }
    ...
    public CommonResult<PageResult<Demo03StudentRespVO>> getDemo03StudentPage(@Valid Demo03StudentPageReqVO pageReqVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, Demo03StudentRespVO.class));
    }
    ...
    public CommonResult<PageResult<Demo03CourseDO>> getDemo03CoursePage(PageParam pageReqVO,
        ...
        return CommonResult.success(demo03StudentService.getDemo03CoursePage(pageReqVO, studentId));
    }
    ...
    public CommonResult<Long> createDemo03Course(@Valid @RequestBody Demo03CourseDO demo03Course) {
        return CommonResult.success(demo03StudentService.createDemo03Course(demo03Course));
    }
    ...
    public CommonResult<Demo03CourseDO> getDemo03Course(@RequestParam("id") Long id) {
        return CommonResult.success(demo03StudentService.getDemo03Course(id));
    }
    ...
    public CommonResult<List<Demo03CourseDO>> getDemo03CourseListByStudentId(@RequestParam("studentId") Long studentId) {
        return CommonResult.success(demo03StudentService.getDemo03CourseListByStudentId(studentId));
    }
    ...
    public CommonResult<PageResult<Demo03GradeDO>> getDemo03GradePage(PageParam pageReqVO,
                                                                      @RequestParam("studentId") Long studentId) {
        return CommonResult.success(demo03StudentService.getDemo03GradePage(pageReqVO, studentId));
    }
    ...
    public CommonResult<Long> createDemo03Grade(@Valid @RequestBody Demo03GradeDO demo03Grade) {
        return CommonResult.success(demo03StudentService.createDemo03Grade(demo03Grade));
    }
    ...
    public CommonResult<Demo03GradeDO> getDemo03Grade(@RequestParam("id") Long id) {
        return CommonResult.success(demo03StudentService.getDemo03Grade(id));
    }
    ...
    public CommonResult<Demo03GradeDO> getDemo03GradeByStudentId(@RequestParam("studentId") Long studentId) {
        return CommonResult.success(demo03StudentService.getDemo03GradeByStudentId(studentId));
    }
