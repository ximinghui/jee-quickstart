package org.example.module.infra.controller.admin.codegen;
...
import org.example.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import org.example.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import org.example.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import org.example.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import org.example.module.infra.convert.codegen.CodegenConvert;
...
import org.example.module.infra.service.codegen.CodegenService;
...
import org.example.module.infra.framework.file.core.utils.FileTypeUtils;
...
public class CodegenController {
    ...
    public CommonResult<List<DatabaseTableRespVO>> getDatabaseTableList(
        ...
        return CommonResult.success(codegenService.getDatabaseTableList(dataSourceConfigId, name, comment));
    }
    ...
    public CommonResult<List<CodegenTableRespVO>> getCodegenTableList(@RequestParam(value = "dataSourceConfigId") Long dataSourceConfigId) {
        ...
        return CommonResult.success(BeanUtils.toBean(list, CodegenTableRespVO.class));
    }
    ...
    public CommonResult<PageResult<CodegenTableRespVO>> getCodegenTablePage(@Valid CodegenTablePageReqVO pageReqVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, CodegenTableRespVO.class));
    }
    ...
    public CommonResult<CodegenDetailRespVO> getCodegenDetail(@RequestParam("tableId") Long tableId) {
        ...
        // 拼装返回
        return CommonResult.success(CodegenConvert.INSTANCE.convert(table, columns));
    }
    ...
    public CommonResult<List<Long>> createCodegenList(@Valid @RequestBody CodegenCreateListReqVO reqVO) {
        return CommonResult.success(codegenService.createCodegenList(getLoginUserId(), reqVO));
    }
    ...
    public CommonResult<List<CodegenPreviewRespVO>> previewCodegen(@RequestParam("tableId") Long tableId) {
        ...
        return CommonResult.success(CodegenConvert.INSTANCE.convert(codes));
    }
