package org.example.module.infra.controller.admin.file;
...
import org.example.module.infra.service.file.FileService;
...
import org.example.module.infra.controller.admin.file.vo.file.*;
...
public class FileController {
    ...
    public CommonResult<FilePresignedUrlRespVO> getFilePresignedUrl(@RequestParam("path") String path) throws Exception {
        return CommonResult.success(fileService.getFilePresignedUrl(path));
    }

    @PostMapping("/create")
    @Operation(summary = "创建文件", description = "模式二：前端上传文件：配合 presigned-url 接口，记录上传了上传的文件")
    public CommonResult<Long> createFile(@Valid @RequestBody FileCreateReqVO createReqVO) {
        return CommonResult.success(fileService.createFile(createReqVO));
    }
