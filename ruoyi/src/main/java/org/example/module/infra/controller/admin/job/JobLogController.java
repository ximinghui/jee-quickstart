...
import org.example.module.infra.controller.admin.job.vo.log.JobLogRespVO;
import org.example.module.infra.dal.dataobject.job.JobLogDO;
import org.example.module.infra.service.job.JobLogService;
...
public class JobLogController {
    ...
    public CommonResult<JobLogRespVO> getJobLog(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(jobLog, JobLogRespVO.class));
    }
    ...
    public CommonResult<PageResult<JobLogRespVO>> getJobLogPage(@Valid JobLogPageReqVO pageVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, JobLogRespVO.class));
    }
