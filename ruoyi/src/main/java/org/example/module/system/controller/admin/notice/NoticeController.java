package org.example.module.system.controller.admin.notice;
...
import org.example.module.infra.api.websocket.WebSocketSenderApi;
import org.example.module.system.controller.admin.notice.vo.NoticePageReqVO;
import org.example.module.system.controller.admin.notice.vo.NoticeRespVO;
import org.example.module.system.controller.admin.notice.vo.NoticeSaveReqVO;
import org.example.module.system.dal.dataobject.notice.NoticeDO;
import org.example.module.system.service.notice.NoticeService;
...
public class NoticeController {
    ...
    public CommonResult<PageResult<NoticeRespVO>> getNoticePage(@Validated NoticePageReqVO pageReqVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, NoticeRespVO.class));
    }
    ...
    public CommonResult<NoticeRespVO> getNotice(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(notice, NoticeRespVO.class));
    }
