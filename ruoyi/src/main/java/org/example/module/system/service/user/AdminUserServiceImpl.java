...
import org.example.framework.common.util.collection.CollectionUtils;
import org.example.framework.common.util.object.BeanUtils;
import org.example.framework.datapermission.core.util.DataPermissionUtils;
import org.example.module.infra.api.file.FileApi;
import org.example.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import org.example.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import org.example.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import org.example.module.system.controller.admin.user.vo.user.UserImportRespVO;
import org.example.module.system.controller.admin.user.vo.user.UserPageReqVO;
...
import org.example.module.system.dal.dataobject.dept.UserPostDO;
import org.example.module.system.dal.dataobject.user.AdminUserDO;
import org.example.module.system.dal.mysql.dept.UserPostMapper;
import org.example.module.system.dal.mysql.user.AdminUserMapper;
import org.example.module.system.service.dept.DeptService;
import org.example.module.system.service.dept.PostService;
import org.example.module.system.service.permission.PermissionService;
import org.example.module.system.service.tenant.TenantService;
...
import static org.example.framework.common.util.collection.CollectionUtils.convertSet;
import static org.example.module.system.enums.ErrorCodeConstants.*;
import static org.example.module.system.enums.LogRecordConstants.*;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    public void updateUserProfile(Long id, UserProfileUpdateReqVO reqVO) {
        ...
        // 执行更新
        AdminUserDO bean = BeanUtils.toBean(reqVO, AdminUserDO.class);
        bean.setId(id);
    ...
    public UserImportRespVO importUserList(List<UserImportExcelVO> importUsers, boolean isUpdateSupport) {
        ...
        importUsers.forEach(importUser -> {
            ...
            if (existUser == null) {
                AdminUserDO bean = BeanUtils.toBean(importUser, AdminUserDO.class);
                bean.setPassword(encodePassword(userInitPassword)); // 设置默认密码及空岗位编号数组
                bean.setPostIds(new HashSet<>());
