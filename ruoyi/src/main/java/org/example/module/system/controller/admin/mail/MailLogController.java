...
import org.example.module.system.controller.admin.mail.vo.log.MailLogRespVO;
import org.example.module.system.dal.dataobject.mail.MailLogDO;
import org.example.module.system.service.mail.MailLogService;
...
public class MailLogController {
    ...
    public CommonResult<PageResult<MailLogRespVO>> getMailLogPage(@Valid MailLogPageReqVO pageVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, MailLogRespVO.class));
    }
    ...
    public CommonResult<MailLogRespVO> getMailTemplate(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(log, MailLogRespVO.class));
    }
