...
import org.example.module.system.controller.admin.mail.vo.account.MailAccountRespVO;
import org.example.module.system.controller.admin.mail.vo.account.MailAccountSaveReqVO;
import org.example.module.system.controller.admin.mail.vo.account.MailAccountSimpleRespVO;
import org.example.module.system.dal.dataobject.mail.MailAccountDO;
import org.example.module.system.service.mail.MailAccountService;
...
public class MailAccountController {
    ...
    public CommonResult<Long> createMailAccount(@Valid @RequestBody MailAccountSaveReqVO createReqVO) {
        return CommonResult.success(mailAccountService.createMailAccount(createReqVO));
    }
    ...
    public CommonResult<MailAccountRespVO> getMailAccount(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(account, MailAccountRespVO.class));
    }
    ...
    public CommonResult<PageResult<MailAccountRespVO>> getMailAccountPage(@Valid MailAccountPageReqVO pageReqVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, MailAccountRespVO.class));
    }
    ...
    public CommonResult<List<MailAccountSimpleRespVO>> getSimpleMailAccountList() {
        ...
        return CommonResult.success(BeanUtils.toBean(list, MailAccountSimpleRespVO.class));
    }
