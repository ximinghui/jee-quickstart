...
import org.example.module.system.controller.admin.tenant.vo.tenant.TenantRespVO;
import org.example.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import org.example.module.system.controller.admin.tenant.vo.tenant.TenantSimpleRespVO;
...
public class TenantController {
    ...
    public CommonResult<Long> getTenantIdByName(@RequestParam("name") String name) {
        ...
        return CommonResult.success(tenant != null ? tenant.getId() : null);
    }
    ...
    public CommonResult<Long> createTenant(@Valid @RequestBody TenantSaveReqVO createReqVO) {
        return CommonResult.success(tenantService.createTenant(createReqVO));
    }
    ...
    public CommonResult<TenantRespVO> getTenant(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(tenant, TenantRespVO.class));
    }
    ...
    public CommonResult<PageResult<TenantRespVO>> getTenantPage(@Valid TenantPageReqVO pageVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, TenantRespVO.class));
    }
