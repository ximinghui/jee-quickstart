package org.example.module.system.api.dict;

import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import org.example.module.system.api.dict.dto.DictDataRespDTO;
...
public interface DictDataApi {
    ...
    default List<String> getDictDataLabelList(String dictType) {
        ...
        return CollectionUtils.convertList(list, DictDataRespDTO::getLabel);
    }
