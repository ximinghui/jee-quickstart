package org.example.module.system.controller.admin.socail;
...
import org.example.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import org.example.module.system.controller.admin.socail.vo.client.SocialClientRespVO;
import org.example.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import org.example.module.system.dal.dataobject.social.SocialClientDO;
import org.example.module.system.service.social.SocialClientService;
...
public class SocialClientController {
    ...
    public CommonResult<Long> createSocialClient(@Valid @RequestBody SocialClientSaveReqVO createReqVO) {
        return CommonResult.success(socialClientService.createSocialClient(createReqVO));
    }
    ...
    public CommonResult<SocialClientRespVO> getSocialClient(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(client, SocialClientRespVO.class));
    }
    ...
    public CommonResult<PageResult<SocialClientRespVO>> getSocialClientPage(@Valid SocialClientPageReqVO pageVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, SocialClientRespVO.class));
    }
