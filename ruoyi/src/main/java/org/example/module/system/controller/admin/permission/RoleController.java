...
import org.example.module.system.controller.admin.permission.vo.role.RoleRespVO;
...
public class RoleController {
    ...
    public CommonResult<Long> createRole(@Valid @RequestBody RoleSaveReqVO createReqVO) {
        return CommonResult.success(roleService.createRole(createReqVO, null));
    }
    ...
    public CommonResult<RoleRespVO> getRole(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(role, RoleRespVO.class));
    }
