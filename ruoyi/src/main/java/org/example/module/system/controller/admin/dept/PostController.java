...
import org.example.module.system.controller.admin.dept.vo.post.PostRespVO;
...
public class PostController {
    ...
    public CommonResult<List<PostSimpleRespVO>> getSimplePostList() {
        ...
        return CommonResult.success(BeanUtils.toBean(list, PostSimpleRespVO.class));
    }
    ...
    public CommonResult<PageResult<PostRespVO>> getPostPage(@Validated PostPageReqVO pageReqVO) {
        ...
        return CommonResult.success(BeanUtils.toBean(pageResult, PostRespVO.class));
    }
