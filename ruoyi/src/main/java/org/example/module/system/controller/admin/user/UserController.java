...
import org.example.module.system.controller.admin.user.vo.user.*;
...
public class UserController {
    ...
    public CommonResult<PageResult<UserRespVO>> getUserPage(@Valid UserPageReqVO pageReqVO) {
        ...
        return CommonResult.success(new PageResult<>(UserConvert.INSTANCE.convertList(pageResult.getList(), deptMap),
                pageResult.getTotal()));
    }
    ...
    public CommonResult<List<UserSimpleRespVO>> getSimpleUserList() {
        ...
        return CommonResult.success(UserConvert.INSTANCE.convertSimpleList(list, deptMap));
    }
    ...
    public CommonResult<UserRespVO> getUser(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(UserConvert.INSTANCE.convert(user, dept));
    }
