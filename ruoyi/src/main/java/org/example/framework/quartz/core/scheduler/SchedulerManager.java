package org.example.framework.quartz.core.scheduler;

import org.example.framework.quartz.core.enums.JobDataKeyEnum;
import org.example.framework.quartz.core.handler.JobHandlerInvoker;
...
public class SchedulerManager {
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw ServiceExceptionUtil.exception0(GlobalErrorCodeConstants.NOT_IMPLEMENTED.getCode(),
