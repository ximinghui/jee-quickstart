package org.example.framework.websocket.config;

import org.example.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import org.example.framework.mq.redis.core.RedisMQTemplate;
import org.example.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import org.example.framework.websocket.core.listener.WebSocketMessageListener;
import org.example.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import org.example.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import org.example.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import org.example.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import org.example.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import org.example.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import org.example.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import org.example.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import org.example.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import org.example.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import org.example.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import org.example.framework.websocket.core.session.WebSocketSessionManager;
import org.example.framework.websocket.core.session.WebSocketSessionManagerImpl;
