package org.example.framework.ip.core.utils;
...
import org.example.framework.ip.core.enums.AreaTypeEnum;
...
import static org.example.framework.common.util.collection.CollectionUtils.findFirst;
...
public class AreaUtils {
    ...
    public static Area parseArea(String pathStr) {
        ...
        for (String path : paths) {
            if (area == null) {
                area = CollectionUtils.findFirst(areas.values(), item -> item.getName().equals(path));
            } else {
