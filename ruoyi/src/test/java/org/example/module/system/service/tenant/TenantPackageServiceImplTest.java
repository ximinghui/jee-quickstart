...
import org.example.module.system.dal.mysql.tenant.TenantPackageMapper;
...
public class TenantPackageServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenantPackage_success() {
        // 准备参数
        TenantPackageSaveReqVO reqVO = randomPojo(TenantPackageSaveReqVO.class, o -> o.setStatus(randomCommonStatus()));
