package org.example.module.system.service.dict;
...
import org.example.module.system.controller.admin.dict.vo.type.DictTypePageReqVO;
import org.example.module.system.controller.admin.dict.vo.type.DictTypeSaveReqVO;
import org.example.module.system.dal.dataobject.dict.DictTypeDO;
import org.example.module.system.dal.mysql.dict.DictTypeMapper;
...
public class DictTypeServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateDictType_success() {
        // 准备参数
        DictTypeSaveReqVO reqVO = randomPojo(DictTypeSaveReqVO.class, o -> o.setStatus(randomEle(CommonStatusEnum.values()).getStatus()));
