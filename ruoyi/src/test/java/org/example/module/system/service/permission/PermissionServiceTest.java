package org.example.module.system.service.permission;
...
import org.example.module.system.api.permission.dto.DeptDataPermissionRespDTO;
import org.example.module.system.dal.dataobject.dept.DeptDO;
import org.example.module.system.dal.dataobject.permission.MenuDO;
import org.example.module.system.dal.dataobject.permission.RoleDO;
import org.example.module.system.dal.dataobject.permission.RoleMenuDO;
import org.example.module.system.dal.dataobject.permission.UserRoleDO;
import org.example.module.system.dal.dataobject.user.AdminUserDO;
import org.example.module.system.dal.mysql.permission.RoleMenuMapper;
import org.example.module.system.dal.mysql.permission.UserRoleMapper;
import org.example.module.system.enums.permission.DataScopeEnum;
...
import static org.example.framework.common.util.collection.SetUtils.asSet;
import static org.example.framework.test.core.util.AssertUtils.assertPojoEquals;
import static org.example.framework.test.core.util.RandomUtils.randomLongId;
...
public class PermissionServiceTest extends BaseDbUnitTest {
    ...
    public void testHasAnyPermissions_superAdmin() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            // mock 用户登录的角色
            UserRoleDO userRoleDO = randomPojo(UserRoleDO.class);
            userRoleDO.setUserId(userId);
            userRoleDO.setRoleId(100L);
    ...
    public void testHasAnyPermissions_normal() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            RoleMenuDO roleMenuDO = randomPojo(RoleMenuDO.class);
            roleMenuDO.setRoleId(100L);
            roleMenuDO.setMenuId(1000L);
    ...
    public void testAssignRoleMenu() {
        ...
        // mock 数据
        RoleMenuDO roleMenu01 = randomPojo(RoleMenuDO.class);
        roleMenu01.setRoleId(1L);
        roleMenu01.setMenuId(100L);
        roleMenuMapper.insert(roleMenu01);
        RoleMenuDO roleMenu02 = randomPojo(RoleMenuDO.class);
        roleMenu02.setRoleId(1L);
        roleMenu02.setMenuId(200L);
    ...
    public void testGetRoleMenuIds_normal() {
        ...
        // mock 数据
        RoleMenuDO roleMenu01 = randomPojo(RoleMenuDO.class);
        roleMenu01.setRoleId(100L);
        roleMenu01.setMenuId(1L);
        roleMenuMapper.insert(roleMenu01);
        RoleMenuDO roleMenu02 = randomPojo(RoleMenuDO.class);
        roleMenu02.setRoleId(100L);
        roleMenu02.setMenuId(2L);
        roleMenuMapper.insert(roleMenu02);
    ...
    public void testGetMenuRoleIdListByMenuIdFromCache() {
        ...
        roleMenuMapper.insert(roleMenu01);
        RoleMenuDO roleMenu02 = randomPojo(RoleMenuDO.class);
        roleMenu02.setRoleId(200L);
        roleMenu02.setMenuId(1L);
        roleMenuMapper.insert(roleMenu02);
    ...
    public void testAssignUserRole() {
        ...
        // mock 数据
        UserRoleDO userRole01 = randomPojo(UserRoleDO.class);
        userRole01.setUserId(1L);
        userRole01.setRoleId(100L);
        userRoleMapper.insert(userRole01);
        UserRoleDO userRole02 = randomPojo(UserRoleDO.class);
        userRole02.setUserId(1L);
        userRole02.setRoleId(200L);
    ...
    public void testGetEnableUserRoleListByUserIdFromCache() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            userRoleDO1.setUserId(userId);
            userRoleDO1.setRoleId(100L);
            userRoleMapper.insert(userRoleDO1);
            UserRoleDO userRoleDO2 = randomPojo(UserRoleDO.class);
            userRoleDO2.setUserId(userId);
            userRoleDO2.setRoleId(200L);
            userRoleMapper.insert(userRoleDO2);
            RoleDO role01 = randomPojo(RoleDO.class, o -> {
                o.setId(100L);
                o.setStatus(CommonStatusEnum.ENABLE.getStatus());
            });
            RoleDO role02 = randomPojo(RoleDO.class, o -> {
                o.setId(200L);
                o.setStatus(CommonStatusEnum.DISABLE.getStatus());
            });
            when(roleService.getRoleListFromCache(eq(asSet(100L, 200L)))).thenReturn(toList(role01, role02));
