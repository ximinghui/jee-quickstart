...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "org.ximinghui";
    private static final String ARTIFACT_ID = "jee-quickstart";
    private static final String PACKAGE_NAME = "org.example";
    private static final String TITLE = "JEE Quick Start";
